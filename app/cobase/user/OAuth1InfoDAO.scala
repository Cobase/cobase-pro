 ...
 */
class OAuth1InfoDAO @Inject() (protected val dbConfigProvider: DatabaseConfigProvider) extends DelegableAuthInfoDAO[OAuth1Info] with HasDatabaseConfigProvider[JdbcProfile] with DBTableDefinitions {
  import driver.api._
