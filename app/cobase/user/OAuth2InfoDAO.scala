 ...
 */
class OAuth2InfoDAO @Inject() (protected val dbConfigProvider: DatabaseConfigProvider) extends DelegableAuthInfoDAO[OAuth2Info] with HasDatabaseConfigProvider[JdbcProfile] with DBTableDefinitions {
  import driver.api._
