 ...
 */
class OpenIDInfoDAO @Inject() (protected val dbConfigProvider: DatabaseConfigProvider) extends DelegableAuthInfoDAO[OpenIDInfo] with HasDatabaseConfigProvider[JdbcProfile] with DBTableDefinitions {
  import driver.api._
