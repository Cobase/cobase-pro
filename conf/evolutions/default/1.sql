...
create table "oauth1_infos" ("id" BIGSERIAL NOT NULL PRIMARY KEY,"token" VARCHAR(254) NOT NULL,"secret" VARCHAR(254) NOT NULL,"login_info_id" BIGINT NOT NULL);
create table "oauth2_infos" ("id" BIGSERIAL NOT NULL PRIMARY KEY,"access_token" VARCHAR(254) NOT NULL,"token_type" VARCHAR(254),"expires_in" INTEGER,"refresh_token" VARCHAR(254),"login_info_id" BIGINT NOT NULL);
create table "openid_attributes" ("id" VARCHAR(254) NOT NULL,"key" VARCHAR(254) NOT NULL,"value" VARCHAR(254) NOT NULL);
create table "openid_infos" ("id" VARCHAR(254) NOT NULL,"login_info_id" BIGINT NOT NULL);
create table "password_infos" ("hasher" VARCHAR(254) NOT NULL,"password" VARCHAR(254) NOT NULL,"salt" VARCHAR(254),"login_info_id" BIGINT NOT NULL);
...
create table "user_login_infos" ("user_id" VARCHAR(254) NOT NULL,"login_info_id" BIGINT NOT NULL);
